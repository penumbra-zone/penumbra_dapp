...
import SelectTypes from 'react-select/dist/declarations/src/Select'
...
export const Select: React.FC<SelectPropsType> = ({
	...
	const inputRef = useRef<null | SelectTypes>(null)
	...
	const changeHandler = (
		...
		handleChange && handleChange((newValue as OptionType).value)
	}
	...
	return (
		<div className={className}>
			...
			<div
				...
				className={`w-[100%] h-[72px] rounded-[10px] flex items-center justify-center
        ${
					isError
						? 'bg-red'
						: isFocus || values
			...
			>
				<div
					className={`w-[calc(100%-2px)] h-[70px] rounded-[10px] bg-brown ${
