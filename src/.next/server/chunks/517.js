...
const _nexturl = __webpack_require__(419);
const _utils = __webpack_require__(5480);
const _error = __webpack_require__(4219);
const _cookies = __webpack_require__(2925);
...
const serverExports = {
    NextRequest: (__webpack_require__(8662).NextRequest),
    NextResponse: (__webpack_require__(9751)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(5930)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(3121).userAgentFromString),
    userAgent: (__webpack_require__(3121).userAgent)
};
